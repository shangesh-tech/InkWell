      ...
      <div className="container-custom py-20">
        <div className="grid md:grid-cols-2 gap-12 pb-16 border-b border-gray-800">
          <div className="space-y-6">
            ...
            <p className="text-gray-300 text-lg leading-relaxed max-w-lg">
              A minimalist journal celebrating thoughtful writing and elegant design. Join our community of curious minds and creative spirits.
            </p>
          </div>
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="group flex items-center justify-center w-10 h-10 rounded-full bg-gray-800 hover:bg-white transition-colors duration-300"
        ...
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-gray-500 text-xl">
            Crafted with <span className="text-red-500 font-bold">♥</span> by Shangesh S
          </p>
        </div>
      </div>
    </footer>
